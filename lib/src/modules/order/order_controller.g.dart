...
mixin _$OrderController on OrderControllerBase, Store {
  late final _$_orderStatusAtom =
      Atom(name: 'OrderControllerBase._orderStatus', context: context);

  OrderStatus? get orderStatus {
    _$_orderStatusAtom.reportRead();
    return super._orderStatus;
  }

  @override
  OrderStatus? get _orderStatus => orderStatus;

  @override
  set _orderStatus(OrderStatus? value) {
    _$_orderStatusAtom.reportWrite(value, super._orderStatus, () {
      super._orderStatus = value;
    });
  }
