...
mixin _$ProductDetailController on ProductDetailControllerBase, Store {
  ...
  late final _$_messageErrorAtom =
      Atom(name: 'ProductDetailControllerBase._messageError', context: context);
  ...
  late final _$saveProductAsyncAction =
      AsyncAction('ProductDetailControllerBase.saveProduct', context: context);

  @override
  Future<void> saveProduct(String name, double price, String description) {
    return _$saveProductAsyncAction
        .run(() => super.saveProduct(name, price, description));
  }
