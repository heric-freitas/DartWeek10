...
mixin _$ProductsController on ProductsControllerBase, Store {
  ...
  late final _$_productModelSelectedAtom = Atom(
      name: 'ProductsControllerBase._productModelSelected', context: context);

  ProductModel? get productModelSelected {
    _$_productModelSelectedAtom.reportRead();
    return super._productModelSelected;
  }

  @override
  ProductModel? get _productModelSelected => productModelSelected;

  @override
  set _productModelSelected(ProductModel? value) {
    _$_productModelSelectedAtom.reportWrite(value, super._productModelSelected,
        () {
      super._productModelSelected = value;
    });
  }
  ...
  @override
  Future<void> filterByName(String value) {
    return _$filterByNameAsyncAction.run(() => super.filterByName(value));
  }
  ...
  Future<void> editProduct(ProductModel model) {
    return _$editProductAsyncAction.run(() => super.editProduct(model));
  }
